...
build-1604715311:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1604715311-inproc

build-1604715311-inproc: ../app.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1604715311 ../app.cfg
configPkg/compiler.opt: build-1604715311
configPkg/: build-1604715311
